...
**Auth testing**: Tests use isolated in-memory SQLite repos per test. Local dev seeding reads `FIRST_ADMIN_*` env vars.
...
- Phase 2 underway: user store now runs on Postgres + Alembic (`alembic/`,
