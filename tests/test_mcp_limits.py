...
def test_pdf_render_stub_has_stacked_burst_and_hourly_limits():
    ...
    registered = limiter._route_limits["app.mcp_limits._limit_pdf_render"]
...
def test_read_stub_has_stacked_burst_and_hourly_limits():
    ...
    registered = limiter._route_limits["app.mcp_limits._limit_read"]
    assert len(registered) == 2
